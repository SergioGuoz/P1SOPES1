...
class Grafica extends Component{
    ...
    componentDidMount() {
        ...
        {
            let url='http://34.72.179.225:3000/ram';
            let urlb='http://34.72.179.225:3000/ram';
            ...
            .then(response=>{
                ...
                datosA.push({x:cantidadA,y:parseInt(response.data.ram)})
            ...
            .then(response=>{
                ...
                datosB.push({x:cantidadA,y:parseInt(response.data.ram)})
                this.setState({
                    datosA:datosA,
                    datosB:datosB,
                    chartData:{
